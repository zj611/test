#include"ros/ros.h"
#include<can_qq/frame.h>
#include"can_qq/control.h"
#include<iostream>
using namespace std;
...
void msgCallback(const can_qq::frame::ConstPtr &msg1)
{
	cout<<"---------------------------------"<<endl;
	cout<<"---------------------------------"<<endl;
	switch(msg1->id)  
...
int main(int argc,char** argv)
{
	...
	control_pub=nh.advertise<can_qq::control>("control_msg",100);
