...
(cl:defmethod cl:initialize-instance :after ((m <frame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'frame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name can-msg:<frame> is deprecated: use can-msg:frame instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can-msg:id-val is deprecated.  Use can-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can-msg:data-val is deprecated.  Use can-msg:data instead.")
  (data m))
