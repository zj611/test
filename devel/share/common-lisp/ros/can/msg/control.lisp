...
(cl:defmethod cl:initialize-instance :after ((m <control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name can-msg:<control> is deprecated: use can-msg:control instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can-msg:speed-val is deprecated.  Use can-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can-msg:angle-val is deprecated.  Use can-msg:angle instead.")
  (angle m))
